...
> **Status:** Complete (2026-06-30). Branch: `feat/anivault-installer` (7 commits). See `docs/superpowers/specs/2026-06-30-anivault-rebrand-installer-design.md` for design rationale.
>
...
**Architecture:** Keep the Phase 0 engine unchanged except for crate/package naming needed for the desktop app identity. Move supplied branding assets into `next/`, display the banner in the Svelte shell, use user-supplied `Icon.ico`, enable Tauri bundling, and build a local installer artifact. Existing C++ Taiga code under `src/` remains untouched.

**Tech Stack:** Tauri v2, Svelte 5, TypeScript, Rust 2021, Windows Tauri bundler.
...
- [x] **Step 6: Commit metadata rebrand**
...
- [x] **Step 1: Add failing asset metadata test**
...
- [x] **Step 3: Copy assets and generate ICO**

> **Note:** PowerShell-generated ICO produced poor desktop icon quality. Replaced by user-supplied `Icon.ico` (202,255 bytes, multi-resolution) in commit `bf572ee4`. The PowerShell ICO generation script below is retained for reference only.
...
- [x] **Step 4: Display banner in Svelte shell**
...
- [x] **Step 5: Run asset test and verify**
...
- [x] **Step 6: Commit assets and UI brand**
...
- [x] **Step 2: Update README with installer command**
...
- [x] **Step 3: Run verification before packaging**
...
- [x] **Step 5: Commit installer script and README**
