# Taiga Next Phase 0 Foundation Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build the non-user-facing foundation for Taiga Next: Tauri/Svelte/Rust scaffold, event boundary, SQLite schema, encrypted secrets, migration skeleton, and verification harness.
...
- [ ] **Step 3: Create minimal dark shell**
...
- [ ] **Step 4: Create Tauri Rust manifest and config**
...
- [ ] **Step 3: Add engine module exports**
...
- [ ] **Step 1: Write failing DPAPI test**
...
- [ ] **Step 4: Implement DPAPI wrapper**
...
- [ ] **Step 3: Add migration implementation**
...
- [ ] **Step 3: Add frontend command wrappers**
...
- [ ] **Step 4: Add Rust Tauri commands**
...
- [ ] **Step 5: Run API tests and Rust tests**
